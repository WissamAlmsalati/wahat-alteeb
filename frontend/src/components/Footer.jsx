          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className={`space-y-2 text-sm text-[var(--text-dark)] mb-5 ${isAr ? 'text-right' : 'text-left'}`}>
              <li>
                ...
                <a href="tel:0942222522" dir="ltr" className="hover:text-[#2FAB4B]">0942222522</a>
              </li>
              <li>
                <span className="text-gray-500 text-xs block">{t('managementPhone')}</span>
                <a href="tel:0912222522" dir="ltr" className="hover:text-[#2FAB4B]">0912222522</a>
              </li>
